...
public class CustomAlertController {
	...
	public CustomAlertController(Context context, DialogInterface di,
			Window window) {
		mContext = context;
		mDialogInterface = di;
		mWindow = window;
	...
	public static class AlertParams {
		...
		private void createListView(final CustomAlertController dialog) {
			final RecycleListView listView = (RecycleListView) mInflater
					.inflate(R.layout.custom_select_dialog, null);
			ListAdapter adapter;

			if (mIsMultiChoice) {
				if (mCursor == null) {
					adapter = new ArrayAdapter<CharSequence>(mContext,
							R.layout.custom_select_dialog_multichoice,
				...
				int layout = mIsSingleChoice ? R.layout.custom_select_dialog_singlechoice
