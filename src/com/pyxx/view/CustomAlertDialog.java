...
public class CustomAlertDialog extends AlertDialog implements DialogInterface {
	...
	public static class Builder extends AlertDialog.Builder {
		 ...
		 * {@link CustomAlertDialog} it creates.
		 */
		...
		/**
		 * Creates a {@link CustomAlertDialog} with the arguments supplied to
		 * this builder. It does not {@link Dialog#show()} the dialog. This
		 * allows the user to do any extra processing before displaying the
		 * dialog. Use {@link #show()} if you don't have any other processing to
		...
		/**
		 * Creates a {@link CustomAlertDialog} with the arguments supplied to
		 * this builder and {@link Dialog#show()}'s the dialog.
		 */
