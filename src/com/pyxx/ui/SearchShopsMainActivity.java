...
public class SearchShopsMainActivity extends BaseFragmentActivity implements OnClickListener {
			 ...
			 if(keyword==null||"".equals(keyword)){
				 ...
				 return;
					...
					fragmentTransaction = getSupportFragmentManager()
							.beginTransaction();
					m_list_frag = SearchZgspShopsListFragment.newInstance("SearchZgspShopsListFragment"+keyword,
							"SearchZgspShopsListFragment"+keyword,getString(R.string.url_sel_shops)+"seller.menuId=7&sort=4&seller.lng="+PerfHelper.getStringData(PerfHelper.P_GPS_LONG)+"&seller.lat="+PerfHelper.getStringData(PerfHelper.P_GPS_LATI));
