...
public class GetAllCityThread extends Thread {
	...
	public Data parseJson(String json) throws Exception {
		...
		if (data != null) {
			initparts_nearby(json, "all_city");
		}
