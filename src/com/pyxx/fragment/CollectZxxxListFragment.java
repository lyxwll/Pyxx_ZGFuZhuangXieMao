...
public class CollectZxxxListFragment extends LoadMoreListFragment<Listitem>{
	...
	public static BaseFragment<Listitem> newInstance(String type,
		...
		final CollectZxxxListFragment tf = new CollectZxxxListFragment();
	...
	public Data parseJson(String json) throws Exception {
		Data data = null;
        data = DBCollectUtil.selectlists("listitemcollect", "list_type", "5");
		return data;
	}
