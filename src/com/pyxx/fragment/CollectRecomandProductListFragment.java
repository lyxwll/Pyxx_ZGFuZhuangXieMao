...
public class CollectRecomandProductListFragment extends LoadMoreListFragment<Pictorial> {
	...
	public static BaseFragment<Pictorial> newInstance(String type,
		...
		CollectRecomandProductListFragment.type = type;
		final CollectRecomandProductListFragment tf = new CollectRecomandProductListFragment();
...
//				tv1.setText(Double.parseDouble(p.other) + "");
	...
	public Data parseJson(String json) throws Exception {
		Data data = new Data();
		 data = DBCollectUtil.selectlists("listitemcollect", "list_type,show_type", "11,1");	
