...
public class CollectZgspShopsListFragment extends LoadMoreListFragment<Listitem> {
	...
	public static BaseFragment<Listitem> newInstance(String type,
		...
		final CollectZgspShopsListFragment tf = new CollectZgspShopsListFragment();
...
//		showpop();
	...
	public Data parseJson(String json) throws Exception {
	     Data data = null;
		 data = DBCollectUtil.selectlists("listitemcollect", "list_type", "7");
		return data;
	}
