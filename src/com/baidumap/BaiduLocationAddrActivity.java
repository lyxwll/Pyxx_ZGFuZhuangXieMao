 ...
 * @author wll
 */
public class BaiduLocationAddrActivity extends BaseFragmentActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		 ...
		 */
		// CityLifeApplication app = CityLifeApplication.getInstance();
		 ...
		 */
		setContentView(R.layout.baiduactivity_mark);
		// 接收传过来的值
		...
		((TextView) findViewById(R.id.title_title)).setVisibility(View.VISIBLE);
		...
		if (item.latitude != null || item.longitude != null) {
			...
			GeoPoint point_n = new GeoPoint((int) (31.764 * 1E6),
					(int) (119.953 * 1E6));
			mMapController.setCenter(point_n);
		}
	}
